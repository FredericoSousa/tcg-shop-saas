...
import { GetCustomerInsightsUseCase } from '@/lib/application/use-cases/customers/get-customer-insights.use-case';
...
import { DeleteCustomerUseCase } from '@/lib/application/use-cases/customers/delete-customer.use-case';
import { GetCustomerCreditHistoryUseCase } from '@/lib/application/use-cases/customers/get-customer-credit-history.use-case';
import { GetCustomerOrdersUseCase } from '@/lib/application/use-cases/customers/get-customer-orders.use-case';
